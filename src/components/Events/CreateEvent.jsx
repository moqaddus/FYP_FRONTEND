...
//         <label>
//           Event Date:
//           <input type="date" name="EventDate" value={formData.EventDate} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//  required />
//         </label>
//         </div>
//         <div className="mb-4">
//         <label>
//           Start Time:
//           <input type="time" name="StartTime" value={formData.StartTime} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//           required />
//         </label>
//         </div>
...
//         <label>
//           End Time:
//           <input type="time" name="EndTime" value={formData.EndTime} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//           required />
//         </label>
//         </div>
//         <div className="mb-4">
//         <label>
//           Location:
//           <input type="text" name="Location" value={formData.Location} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//           required />
//         </label>
//         </div>
//         <div className="mb-4">
//           <label>
//             Total Tickets:
//             <input type="number" name="TotalTickets" value={formData.TotalTickets} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//             required />
//           </label>
//         </div>
//         <div className="mb-4">
//         <label>
//           Tickets Price:
//           <input type="number" name="TicketPrice" value={formData.TicketPrice} onChange={handleChange} className="mt-1 p-2 block w-full border border-gray-300 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
//           required />
//         </label>
//         </div>
...
//                 <div className="absolute mt-1 w-full bg-white rounded-md shadow-lg border border-gray-300 z-10">
...
const CreateEventForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(process.env.URL+`Events/Register`, formData, config);
      setSuccessMessage('Event created successfully');
      setErrorMessage(''); // Clear previous error message
      console.log(response.data);
    } catch (error) {
